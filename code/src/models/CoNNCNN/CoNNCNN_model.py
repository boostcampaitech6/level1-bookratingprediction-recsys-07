...
class CoNNCNN(nn.Module):
    def __init__(self, args, data):
        ...
        self.fm = FactorizationMachine(
                                        input_dim=(args.conv_1d_out_dim * 2) + (args.conncnn_embed_dim*len(self.field_dims)) + (12 * 1 * 1),
                                        latent_dim=args.conncnn_latent_dim,
                                        )
